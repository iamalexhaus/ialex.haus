 ...
 * Каждая запись должна содержать заголовок и имя файла, остальные необязательны.
 * For simplicity in merges, please add to the bottom of the object.
 * Для простоты слияния, пожалуйста, добавьте в нижнюю часть объекта.
 * interface - интерфейс
 * {
 *     title: string // display name - заголовок: строка // отображаемое имя
 *     filename: string // the name of your HTML file - имя файла: строка // имя вашего HTML-файла
 *     description?: string // description that will be listed with your entry - описание?: строка // описание, которое будет указано вместе с вашей записью
 *     author?: string // your name/tag that will be listed - автор?: строка // ваше имя/тег, который будет указан
 *     github?: string // username on github that will display a link to your profile - строка // имя пользователя на github, в которой будет отображаться ссылка на ваш профиль
 *     compatibleBrowsers?: array // browsers that this page is compatible with - Совместимые браузеры?: массив // браузеров, с которыми совместима эта страница
 * {
 * }
 */
